      ...
      <div className={`p-3 mx-3 my-3 text-center ${styles.exp} `}>
        <div className="container py-3">
          ...
          <p className="col-lg-8 mx-auto lead">
            ...
            document automation tools. Utilized SQL and NoSQL (MongoDB)
            databases to extract, clean, and structure large datasets for
            ...
            test document generation workflows in a production-like environment.
              ...
              <br />
                📜Developed ML models with Python, NLP, TensorFlow, Scikit-learn
              <br/>
